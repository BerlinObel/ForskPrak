...
for kwargs in ParameterGrid(kwarg_grid):
        ...
        ax.hist(bulk_chi, bins=200, histtype='bar', color='steelblue', alpha=0.9)
        ax.hist(bulkouter, bins=200, histtype='bar', color='orange', alpha=0.6)
        ...
        ax2.legend(['Bulk_chi','combined','outer'], loc='right')
